...
class RegisterInfo extends $pb.GeneratedMessage {
  ...
  factory RegisterInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RegisterInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  RegisterInfo copyWith(void Function(RegisterInfo) updates) =>
      super.copyWith((message) => updates(message as RegisterInfo))
          as RegisterInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RegisterInfo create() => RegisterInfo._();
  RegisterInfo createEmptyInstance() => create();
  static $pb.PbList<RegisterInfo> createRepeated() =>
      $pb.PbList<RegisterInfo>();
  @$core.pragma('dart2js:noInline')
  static RegisterInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RegisterInfo>(create);
...
class LoginInfo extends $pb.GeneratedMessage {
  ...
  factory LoginInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LoginInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  LoginInfo copyWith(void Function(LoginInfo) updates) =>
      super.copyWith((message) => updates(message as LoginInfo))
          as LoginInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static LoginInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LoginInfo>(create);
...
class RegisterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<RegisterInfo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'registerInfo',
        subBuilder: RegisterInfo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set registerInfo(RegisterInfo v) {
    setField(2, v);
  }
...
class RefreshTokenRequest extends $pb.GeneratedMessage {
  ...
  RefreshTokenRequest copyWith(void Function(RefreshTokenRequest) updates) =>
      super.copyWith((message) => updates(message as RefreshTokenRequest))
          as RefreshTokenRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ContentPullRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.SyncTimestamp>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'syncTimestamp',
        subBuilder: $0.SyncTimestamp.create)
    ..hasRequiredFields = false;
  ...
  factory ContentPullRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContentPullRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ContentPullRequest copyWith(void Function(ContentPullRequest) updates) =>
      super.copyWith((message) => updates(message as ContentPullRequest))
          as ContentPullRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ContentPullRequest create() => ContentPullRequest._();
  ContentPullRequest createEmptyInstance() => create();
  static $pb.PbList<ContentPullRequest> createRepeated() =>
      $pb.PbList<ContentPullRequest>();
  @$core.pragma('dart2js:noInline')
  static ContentPullRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContentPullRequest>(create);
  ...
  @$pb.TagNumber(2)
  set syncTimestamp($0.SyncTimestamp v) {
    setField(2, v);
  }
...
class ContentPushRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$0.FeedUpdateRecord>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'feedUpdateRecords',
        $pb.PbFieldType.PM,
        subBuilder: $0.FeedUpdateRecord.create)
    ..pc<$0.FeedGroup>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory ContentPushRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContentPushRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ContentPushRequest copyWith(void Function(ContentPushRequest) updates) =>
      super.copyWith((message) => updates(message as ContentPushRequest))
          as ContentPushRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ContentPushRequest create() => ContentPushRequest._();
  ContentPushRequest createEmptyInstance() => create();
  static $pb.PbList<ContentPushRequest> createRepeated() =>
      $pb.PbList<ContentPushRequest>();
  @$core.pragma('dart2js:noInline')
  static ContentPushRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContentPushRequest>(create);
