...
class RegisterRequest {
  ...
  int get hashCode =>
    ...
    (client.hashCode) +
    (registerInfo.hashCode);

  @override
  String toString() => 'RegisterRequest[client=$client, registerInfo=$registerInfo]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'client'] = this.client;
      json[r'registerInfo'] = this.registerInfo;
    return json;
  }
  ...
  static RegisterRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return RegisterRequest(
        ...
        registerInfo: RegisterInfo.fromJson(json[r'registerInfo'])!,
      );
    }
    return null;
  }
